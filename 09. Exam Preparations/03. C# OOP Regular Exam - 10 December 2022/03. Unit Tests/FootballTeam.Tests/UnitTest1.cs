...
namespace FootballTeam.Tests
{
    public class Tests
    {
        ...
        {
            FootballTeam team = new FootballTeam("Manchester United", 21);
        ...
        {
            FootballTeam team = new FootballTeam("Manchester United", 21);
            FootballPlayer player = new FootballPlayer("Marcus Rashford", 10, "Forward");
        ...
        public void AddMethodShouldReturnTheCorrectMessageIfTryingToAddMoreFootballersThanTheCapacity()
        {
            ...
            FootballTeam team = new FootballTeam("Manchester United", 15);
        ...
        public void PickPlayerMethodShouldPickPlayersCorrectly()
        {
            ...
            FootballPlayer searchedPlayer1 = team.PickPlayer("Marcus Rashford");
            FootballPlayer searchedPlayer2 = team.PickPlayer("Anthony Martial");
        ...
        public void PlayerScoreMethodShouldPickPlayerAndScoreCorrectly()
        {
            ...
            string expectedMessage = team.PlayerScore(10);
